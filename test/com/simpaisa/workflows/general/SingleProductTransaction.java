...
public class SingleProductTransaction {


    @Test(enabled = true, groups = {"wifi","workflow"})
    public void SingleproductUnlimitedtransaction() throws IOException, URISyntaxException {

        //Note: No Threshold applied, sufficient balance , Product, Operator, mobile all in place (properties)
       ...
       //TODO: must have DB verification, There must not be entry of user in Recursion table and user must have entry in Transaction tablewith satus = 1
    }
